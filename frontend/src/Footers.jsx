    ...
    return (
        <div className='theFooter'>
            ...
            <div className="navFooter" class="col-xs-6 col-sm-6">
                    ...
                    <h4 className='title01'><Link className='menu' to={"/tgims"}>TGIM</Link></h4>
                ...
                <div className="contactFooter" class="col-xs-6 col-sm-6">
                    ...
                    <h4 className='title01'><a className='menu' target='_blank' href="https://github.com/mrelirooney/">GitHub</a></h4>
                </div>
            </div>
            <div class="row">
